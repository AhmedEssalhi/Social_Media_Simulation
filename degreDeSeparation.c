//Fonction pour retourner le degré de séparation entre deux utilisateurs
int degreSeparation(struct Graph* graph, int id1, int id2) //j'ai pris les id chaque utilisateur a son id spécifique ce qui permet d'eviter les erreurs de collision
{
